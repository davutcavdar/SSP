...
public class InitiatorTerminalTagScanner extends AbstractTerminalTagScanner implements Runnable {
	...
	private void handleCard(Card card) {
		...
		if (tagType.equals(TagType.NFCIP)) {
			System.out.println("TagType.NFCIP");
		}
		else if (tagType.equals(TagType.FELICA_212K)) {
			System.out.println("TagType.FELICA_212K");
		}
		else if (tagType.equals(TagType.FELICA_424K)) {
			System.out.println("TagType.FELICA_424K");
		}
		else if (tagType.equals(TagType.MIFARE_CLASSIC_1K)) {
			System.out.println("TagType.MIFARE_CLASSIC_1K");
		}
		
		if (tagType.equals(TagType.NFCIP) || tagType.equals(TagType.FELICA_212K) || tagType.equals(TagType.FELICA_424K)) {
			connectAsInitiator(acsTag);
		}
		else {
			System.out.println("InitiatorTerminalTagScanner.handleCard()");
