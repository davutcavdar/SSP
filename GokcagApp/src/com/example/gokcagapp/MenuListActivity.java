...
/**
 * An activity representing a list of Menu. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link MenuDetailActivity} representing item details. On tablets, the
...
public class MenuListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//editor.putString("CARD_EMULATION_SUPPORT", "00000000");
		//editor.commit();
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.menu_detail_container, fragment).commit();
